...
**Why it matters:** Primary database crashes? Standby takes over in <30 seconds.
...
| **Sentry** | Error tracking & alerts | Free (<10K errors/month) |
...
- Prediction volume anomalies (alert if <50% of expected volume)
...
3. Assess severity:
   ...
   - P2: Degraded performance (<50% affected)
...
2. **[Sentry](https://sentry.io/)** - Free error tracking (<10K events/month)
